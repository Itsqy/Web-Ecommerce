 ...
 {{-- <input id="addOffice" type="text" name="sedia" required="required" class="form-control"> --}}
                                                        <div class="col-lg-4 col-md-9 col-sm-8">
                                                            <select class="@error('sedia') is invalid @enderror form-control input-fixed" name="sedia" id="">
                                                                ...
                                                                <option value="Available" @if (old('sedia')) == "Available") selected="selected" @endif>Tersedia</option>
                                                                <option value="Unavailable" (old('sedia')) == "Unavailable" ? 'selected' : '' }}>Kosong</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <table id="add-row" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>
                                            <img src="{{url('storage/'.$p->img)}}" alt="" style="max-width: 100px !important; border-radius:5px;">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('produk.edit',  $p->id)}}"><button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary" data-original-title="Edit">
