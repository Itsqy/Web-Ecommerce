                                    ...
                                    <div class="form">
                                        ...
                                        <div class="form-group form-show-notify row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" name="nama" value="{{$produk->nama}}" class="form-control input-fixed" id="exampleInputPassword1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-show-notify row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                         <select class="@error('kategori_id') is invalid @enderror form-control input-fixed" name="kategori_id" >
                                                                ...
                                                                <option value="{{$k->id}}" @if ($k->id == $produk->kategori_id) selected="selected" @endif>{{$k->nama_kategori}}</option>
                                                                @endforeach
                                                            </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-show-notify row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                            <img src="{{url('storage/'.$produk->img)}}" alt="" style="max-width: 100px !important; border-radius:5px;">
                                        </div>
                                        <div class="form-group form-show-notify row">
                                            <div class="col-lg-3 col-md-3 col-sm-4 text-right">
                                            </div>
                                ...
                                <div class="form">
                                    <div class="form-group from-show-notify row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <button id="displayNotif" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                        </div>
                                    </div>
                                </div>
